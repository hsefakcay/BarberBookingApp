  ...
  ThemeData get darkTheme => ThemeData(
        ...
        textButtonTheme: TextButtonThemeData(
          style: TextButton.styleFrom(
            textStyle: const TextStyle(
                color: ColorConstants.yellowColor, fontSize: 16, fontWeight: FontWeight.bold,),
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          border: OutlineInputBorder(
              ...
              borderSide: const BorderSide(color: ColorConstants.greyColor),), // Giriş alanı kenarlığı
        ),
        ...
        buttonTheme: const ButtonThemeData(
            colorScheme: ColorScheme.dark(
                onPrimary: ColorConstants.yellowColor, onSecondary: ColorConstants.yellowColor,),),
